...
//        }
    ...
    public Devolucion buscarPorID(String id) throws PersistenceException {
        ...
        MetodoPago metodoPago = new MetodoPago(new Efectivo());

        // Crear pago
        Pago pago = new Pago();
        pago.setMetodoPago(metodoPago);
        pago.setFechaHora(LocalDateTime.now().minusDays(1));
        pago.setMonto(348.00); // total de la venta
        ...
        venta.setPago(pago); // Aquí se setea el pago completo
