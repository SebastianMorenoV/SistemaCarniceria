 ...
 * @author HP
 */
public class seleccionarProductoCargadoDTO extends javax.swing.JPanel {
     ...
     * @param control
     */
    public seleccionarProductoCargadoDTO(controlRegistrarEntrada control) {
    ...
    private void tablaProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaProductosMouseClicked
        ...
        if(evt.getClickCount() == 2){ 
           productoSeleccionado =control.ProductoSeleccionado(tablaProductos.getSelectedRow());
    ...
    public void productoSeleccionado(){
        control.setProductoCargado(productoSeleccionado);
    }
}
